      ...
      <div className="location-view container">
        ...
        <div className="row actions">
          {location.domain && location.domain.name === "Targaryen" ? (
            <div className="col">
              <button className="btn btn-block btn-action btn-danger" onClick={onMoveUnits.bind(null, location.id)}>
                Move Troops
              </button>
            </div>
          ) : null}
          <div className="col">
            <button className="btn btn-block btn-action btn-danger" onClick={doNextDay}>
              Next Day
            </button>
          </div>
        </div>
